(function ($) {
	...
	$('#contactForm').validate({
		...
		highlight: function (element) {
			$(element).closest('#contactform').addClass('has-errors');
		},
		unhighlight: function (element) { // revert the change done by hightlight
			$(element)
				.closest('').removeClass('has-errors'); // set error class to the control group
		},
		success: function (label) {
			label
				.closest('#contactform').removeClass('has-errors'); // set success class to the control group
		},
	...
	// 	};
	// 	waitMeShow('#body');
	// 	fetch('../../controllers/form-process.php', {
	// 		method: "POST",
